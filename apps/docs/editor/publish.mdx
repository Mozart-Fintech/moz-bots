...
- "Close mozbot to new responses": close your mozbot and your users will see the following message: "This bot is now closed."
- "Unpublish mozbot": mark the mozbot as unpublished and your users will see the following message: "The bot you're looking for doesn't exist"
