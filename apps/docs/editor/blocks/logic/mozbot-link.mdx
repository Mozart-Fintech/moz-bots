---
title: Link to mozbot
icon: box
---

The mozbot link logic block allows you to go into another mozbot flow. This ultimately helps keep your flows clean and be able to reuse a flow in multiple places.

<Frame>
  <img src="/images/blocks/logic/link.png" alt="Link to mozbot logic block" />
</Frame>
