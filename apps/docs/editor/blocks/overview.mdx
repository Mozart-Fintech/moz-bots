...
Blocks are the atomic building blocks of a mozbot chat. You can chain any blocks together to create complexe conversation flows. When you drag and drop a block in the mozbot flow, by default it will be inserted into a group that can have a title. Blocks are always contained in groups.
