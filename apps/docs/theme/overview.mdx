...
The theme tab allows you to customize the look of your mozbot.

## Global

This section allows you to enable or disable the mozbot branding, change the font and the background of your bot.
