...
The [official Mozbot blog](https://mozbot.io/blog) is a place where we share any ideas, original content related to the chatbot industry, and Mozbot itself.

You are free to contribute to the blog or fix any typos you may find.

1. Head over to the [content folder](https://github.com/baptisteArno/mozbot.io/tree/main/apps/landing-page/content) on the Github repo.
...
- The article should be related to chatbots, or Mozbot.
...
- `Mozbot`: To embed a mozbot as a Standard component. Example: `<Mozbot mozbot="<YOUR_BOT_PUBLIC_ID>" />`. You can provide the same props as the [Standard component](../../deploy/web/libraries/react#standard).
...
- `Cta`: To display a call-to-action that redirects to Mozbot. Example: `<Cta />`
