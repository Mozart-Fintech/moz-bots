...
You may want to [disable the Github actions](https://docs.github.com/en/actions/using-workflows/disabling-and-enabling-a-workflow) as they are most likely not relevant to your use of Mozbot. This can be done.
...
2. Change the project name to: `mozbot-builder` (or anything else)
...
1. Create a new Vercel project and import the forked repo
2. Change the project name to: `mozbot-viewer` (or anything else)
3. Choose Next.js framework
