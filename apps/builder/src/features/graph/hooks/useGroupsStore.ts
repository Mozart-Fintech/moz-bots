...
import { Edge, Group, GroupV6, Variable } from '@mozbot.io/schemas'
...
type Store = {
  ...
  // TO-DO: remove once Mozbot provider is migrated to a Zustand store. We will be able to get it internally in the store (if mutualized).
