...
export const BlockNode = ({
  ...
  const { mozbot, updateBlock } = useMozbot()
  ...
  const groupId = mozbot?.groups.at(indices.groupIndex)?.id
  ...
  const hasIcomingEdge = mozbot?.edges.some((edge) => {
          ...
          <PopoverTrigger>
            ...
            >
              ...
              >
                ...
                {mozbot?.groups.at(indices.groupIndex)?.id && (
                  <BlockNodeContent
                    block={block}
                    indices={indices}
                    groupId={mozbot.groups.at(indices.groupIndex)?.id as string}
                  />
                )}
