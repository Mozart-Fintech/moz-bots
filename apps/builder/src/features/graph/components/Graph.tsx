...
import { BlockV6, PublicMozbotV6, MozbotV6 } from '@mozbot.io/schemas'
...
export const Graph = ({
  ...
  mozbot: MozbotV6 | PublicMozbotV6
  ...
  const [graphPosition, setGraphPosition] = useState(
    graphPositionDefaultValue(
      mozbot.events[0].graphCoordinates ?? { x: 0, y: 0 }
    )
  )
  ...
  const handleMouseUp = (e: MouseEvent) => {
    ...
    const newBlockId = createGroup({
      ...
      indices: { groupIndex: mozbot.groups.length, blockIndex: 0 },
    })
