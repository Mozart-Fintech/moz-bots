...
import { MozbotDndProvider } from '@/features/folders/MozbotDndProvider'
import { ParentModalProvider } from '@/features/graph/providers/ParentModalProvider'
import { trpc } from '@/lib/trpc'
import { guessIfUserIsEuropean } from '@mozbot.io/billing/helpers/guessIfUserIsEuropean'
  ...
  useEffect(() => {
    ...
    if (claimCustomPlan && user?.email && workspace) {
      ...
      createCustomCheckoutSession({
        ...
        returnUrl: `${window.location.origin}/mozbots`,
      })
    }
