/*
  ...
  - Made the column `workspaceId` on table `Mozbot` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE "Mozbot" ALTER COLUMN "workspaceId" SET NOT NULL;
