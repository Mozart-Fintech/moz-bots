/*
  ...
  - You are about to drop the column `ownerId` on the `Mozbot` table. All the data in the column will be lost.
...
-- DropForeignKey
ALTER TABLE "Mozbot" DROP CONSTRAINT "Mozbot_ownerId_fkey";
...
-- DropIndex
DROP INDEX "Mozbot_id_ownerId_key";
...
-- AlterTable
ALTER TABLE "Mozbot" DROP COLUMN "ownerId";
