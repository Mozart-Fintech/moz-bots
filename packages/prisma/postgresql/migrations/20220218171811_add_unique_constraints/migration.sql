/*
  ...
  - A unique constraint covering the columns `[id,ownerId]` on the table `Mozbot` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Mozbot_id_ownerId_key" ON "Mozbot"("id", "ownerId");
