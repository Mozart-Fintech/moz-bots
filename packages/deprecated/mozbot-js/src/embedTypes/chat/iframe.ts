...
export const openIframe = (bubble: Element): void => {
  const iframe = bubble.querySelector('.mozbot-iframe') as HTMLIFrameElement
  loadMozbotIfFirstOpen(iframe)
...
export const loadMozbotIfFirstOpen = (iframe: HTMLIFrameElement): void => {
