  ...
  <Mjml>
    ...
    <MjmlBody width={600}>
      ...
      <MjmlSection padding="0 24px" cssClass="smooth">
        <MjmlColumn>
          <Text>
            You have been invited by {hostEmail} to collaborate on his mozbot{' '}
            <strong>{mozbotName}</strong>.
          </Text>
          <Text>
            From now on you will see this mozbot in your dashboard under his
          ...
          <Button link={url}>Go to mozbot</Button>
        </MjmlColumn>
      </MjmlSection>
    </MjmlBody>
  </Mjml>
