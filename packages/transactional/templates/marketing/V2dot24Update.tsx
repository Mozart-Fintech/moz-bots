...
export const V2dot24Update = ({}: Props) => (
  <Html>
    <Head />
    <Preview>Unveiling Mozbot's Latest Innovations - v2.24 Update! 🌟</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Hey, <br />
          <br />
          Mozbot v2.24 was just released. This update introduces powerful new
        ...
        <Section style={featureSection}>
          ...
          <Text style={text}>
            ...
            back to the mozbot, it will display the previous chat state.
            <br />
            <br />
        ...
        <Section style={featureSection}>
          ...
          <Text style={text}>
            ...
            literaly all of the known issues and reported bugs to make Mozbot
            more reliable.
            <br />
            <br />
            And from now on I've decided to always focus fixing newly reported
            bugs. That's that kind of standard I want to set for Mozbot.
            <br />
            <br />
            Check out the full changelog{' '}
            <Link href="https://github.com/baptisteArno/mozbot.io/releases/tag/v2.24.0">
              here
            </Link>
            !
          </Text>
        ...
        <Text style={footer}>Mozbot.io - Powering Conversations at Scale</Text>
        <Link
          href="{{unsubscribe}}"
          target="_blank"
