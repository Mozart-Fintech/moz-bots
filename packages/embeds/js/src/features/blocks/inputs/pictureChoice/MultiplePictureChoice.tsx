...
import { isDefined, isEmpty, isNotEmpty, isSvgSrc } from '@mozbot.io/lib'
        ...
        <For each={filteredItems()}>
          {(item, index) => (
            <div
              ...
              class={
                'flex flex-col focus:outline-none cursor-pointer select-none mozbot-selectable-picture' +
        ...
        >
          {(selectedItem, index) => (
            <div
              ...
              class={
                'flex flex-col focus:outline-none cursor-pointer select-none mozbot-selectable-picture selected'
              }
