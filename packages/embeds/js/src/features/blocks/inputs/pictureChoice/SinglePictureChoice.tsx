...
import { isDefined, isNotEmpty, isSvgSrc } from '@mozbot.io/lib/utils'
        ...
        <For each={filteredItems()}>
          {(item, index) => (
            <button
              ...
              data-itemid={item.id}
              class={
                'flex flex-col mozbot-picture-button focus:outline-none filter hover:brightness-90 active:brightness-75 justify-between  ' +
