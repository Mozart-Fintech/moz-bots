...
import { CustomEmbedBubble as CustomEmbedBubbleProps } from '@mozbot.io/schemas'
  ...
  return (
    ...
    >
      <div class="flex w-full items-center">
        <div class="flex relative z-10 items-start mozbot-host-bubble w-full max-w-full">
          <div
