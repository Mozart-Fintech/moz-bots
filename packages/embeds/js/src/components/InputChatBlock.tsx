...
import { defaultGuestAvatarIsEnabled } from '@mozbot.io/schemas/features/mozbot/theme/constants'
...
export const InputChatBlock = (props: Props) => {
  const [answer, setAnswer] = persist(createSignal<Answer>(), {
    key: `mozbot-${props.context.mozbot.id}-input-${props.chunkIndex}`,
  ...
  return (
    <Switch>
      ...
      <Match when={isNotDefined(answer()) || props.hasError}>
        <div
          class="flex justify-end animate-fade-in gap-2 mozbot-input-container"
