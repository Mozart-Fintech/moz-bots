...
import { PublicMozbot } from '@mozbot.io/schemas'
...
export const IntroducingChatApps = () => {
  ...
  const fetchTemplate = async () => {
    const { data, error } = await sendRequest(`/mozbots/lead-gen-lp.json`)
    if (error) return
    setMozbot(data as PublicMozbot)
  }
      ...
      >
        <Stack spacing={6} w="full">
          ...
          <Text
            ...
            data-aos="fade"
          >
            Mozbot is a better way to ask for information. It leads to an
