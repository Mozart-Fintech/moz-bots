...
import { parseNumberWithCommas } from '@mozbot.io/lib'
import { chatsLimits, prices, seatsLimits } from '@mozbot.io/billing/constants'
  ...
  <Stack spacing="12">
      ...
      <Table>
        ...
        <Tbody>
          ...
          <Tr>
            <TdWithTooltip
              text="Folders"
              tooltip="Organize your mozbots into folders"
            />
            <Td />
            <Td>Unlimited</Td>
            <Td>Unlimited</Td>
    ...
    >
      <Stack spacing={4}>
        ...
        <Link href="https://app.mozbot.io/register">
      ...
      <Stack spacing={4}>
        ...
        <Link
          href={`https://app.mozbot.io/register?subscribePlan=${Plan.STARTER}`}
        >
      ...
      <Stack spacing={4}>
        ...
        <Link href={`https://app.mozbot.io/register?subscribePlan=${Plan.PRO}`}>
