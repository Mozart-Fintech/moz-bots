    ...
    children: [
      {
        ...
        href: 'https://github.com/baptisteArno/mozbot.io',
        icon: <GitHubIcon fill="blue.300" />,
      },
      {
        label: 'Documentation',
        description:
          "Everything you need to know about how to use Mozbot's builder",
        href: 'https://docs.mozbot.io',
        icon: <DocIcon />,
      },
      {
        label: 'Blog',
        description:
          'Read the latest news and updates about Mozbot and the chatbots ecosystem',
        href: '/blog',
        icon: <NewspaperIcon />,
      },
      {
