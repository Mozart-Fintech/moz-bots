...
const AboutPage = () => {
  return (
    <div className="flex flex-col items-center w-full overflow-x-hidden ">
      <Header />
      <SocialMetaTags currentUrl={`https://www.mozbot.io/about`} />
      <Stack
        spacing={10}
        mx="auto"
        maxW="3xl"
      ...
      >
        <Flex w="full">
          <Heading as="h1">Why Mozbot?</Heading>
        </Flex>
        <Text>
        ...
        <Text>
          This is why I&apos;ve started working on Mozbot, 3 years ago. It is my
        ...
        <Text>This is what Mozbot provides.</Text>
        <Text>
          I&apos;ve built this tool by focusing on user empowering. Mozbot is
          ...
          with Mozbot by providing the best defaults for each option. I also try
          to help you learn master the tool with good templates and video
          tutorials.
        </Text>
      </Stack>
      <EndCta heading="Improve conversion and user engagement with mozbots" />
      <Footer />
    </div>
  )
}
