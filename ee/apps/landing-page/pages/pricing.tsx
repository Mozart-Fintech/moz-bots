  ...
  return (
    <Stack overflowX="hidden" bgColor="gray.900">
      ...
      <Flex
        ...
        pb={40}
      >
        <SocialMetaTags currentUrl={`https://www.mozbot.io/pricing`} />
        <BackgroundPolygons />
        <DarkMode>
          <Header />
        </DarkMode>
          ...
          <Stack align="center" spacing="12" w="full" px={4}>
            <VStack>
              ...
              >
                ...
                , Mozbot is here to help you build high-performing chat forms
            ...
            >
              <StripeClimateLogo />
              <Text fontSize="sm">
                Mozbot is contributing 1% of your subscription to remove CO₂
                from the atmosphere.{' '}
