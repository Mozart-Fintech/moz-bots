...
const PrivacyPolicies = () => {
  return (
    <div className="flex flex-col items-center w-full overflow-x-hidden ">
      <SocialMetaTags currentUrl={`https://www.mozbot.io/terms-of-service`} />
      <Header />
      <Stack spacing={10} mx="auto" maxW="3xl" my="20">
        ...
        <p>
          By accessing this Website, accessible from https://mozbot.io and
          https://app.mozbot.io, you are agreeing to be bound by these Website
        ...
        <p>
          ...
          materials on Mozbot&apos;s Website for personal, non-commercial
        ...
        <p>
          This will let Mozbot to terminate upon violations of any of these
        ...
        <p>
          All the materials on Mozbot&apos;s Website are provided &quot;as
          is&quot;. Mozbot makes no warranties, may it be expressed or implied,
          therefore negates all other warranties. Furthermore, Mozbot does not
        ...
        <p>
          Mozbot or its suppliers will not be hold accountable for any damages
          that will arise with the use or inability to use the materials on
          Mozbot&apos;s Website, even if Mozbot or an authorize representative
        ...
        <p>
          The materials appearing on Mozbot&apos;s Website may include
          technical, typographical, or photographic errors. Mozbot will not
          promise that any of the materials in this Website are accurate,
          complete, or current. Mozbot may change the materials contained on its
          Website at any time without notice. Mozbot does not make any
        ...
        <p>
          Mozbot has not reviewed all of the sites linked to its Website and is
          not responsible for the contents of any such linked site. The presence
          of any link does not imply endorsement by Mozbot of the site. The use
        ...
        <p>
          Mozbot may revise these Terms of Use for its Website at any time
          without prior notice. By using this Website, you are agreeing to be
          bound by the current version of these Terms and Conditions of Use.
        </p>

        <Heading id="scam-mozbots">8. Prohibition of Scam Mozbots</Heading>
        <p>
          You agree not to create or use mozbots on Mozbot&apos;s Website for
          the purpose of engaging in fraudulent activities, scamming
          individuals, or any other unethical or illegal activities. This
          includes but is not limited to mozbots designed to deceive, defraud,
          or mislead people for financial gain or personal benefit. Mozbot
          reserves the right to take appropriate action, including the
          termination of any user account, if it determines that a mozbot is
        ...
        <p>
          Any claim related to Mozbot&apos;s Website shall be governed by the
