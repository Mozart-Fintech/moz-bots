...
## Step-by-Step Setup Guide Using Mozbot

1. **Create a New Mozbot**: First, sign up and log in to Mozbot. From the dashboard, create a new chatbot.

<Image
  src="/images/blog/lead-generation-chatbot/create-new-mozbot.png"
  alt="How to create a new Mozbot"
  width="2000"
  height="1019"
/>

2. **Create a Welcome Message**: Use the Mozbot builder to design your conversation
   flow. Start with an engaging greeting to welcome users.

<Image
  src="/images/blog/lead-generation-chatbot/create-welcome-message.gif"
  alt="How to create a welcome message in Mozbot"
  width="800"
  height="631"
/>
...
<Image
  ...
  alt="How to ask for an email in Mozbot"
  width="800"
  height="631"
/>
...
<Image
  ...
  alt="How to send a response in a Google Sheets in Mozbot"
  width="2000"
  height="857"
/>
...
Start boosting your sales today by creating your own lead generation with our [chatbot builder for lead generation](https://mozbot/io).
