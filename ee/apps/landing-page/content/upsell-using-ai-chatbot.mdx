...
<Callout status="info" title="Good to know">
  ...
  your own data](https://mozbot.io/blog/train-chatbot-on-your-own-data)
</Callout>
...
With your prompt crafted and product knowledge uploaded, your OpenAI assistant is ready to roll! It's like you've just hired the world's fastest-learning sales associate. Next up, we'll connect this brainiac to a user-friendly interface with Mozbot. Get ready to see your upselling game reach new heights!

## Building a Mozbot Chatbot

Alright, folks, we're about to enter the Mozbot playground! This is where we'll give our AI assistant a snazzy interface that'll charm the socks off your customers. Let's dive in!

### Designing Your Chatbot Flow

Mozbot's drag-and-drop interface is like Lego for chatbots - fun, intuitive, and surprisingly powerful. Here's how to craft a flow that'll make your customers feel like they're chatting with a friendly, all-knowing shop assistant:
...
- Use visuals: Mozbot lets you add images. Use them to showcase products or add some personality to your bot.
...
<Image
  ...
  height={558}
/>
In Mozbot, create a new variable called "Current product". Select 'Custom' in Value,
...
This little bit of code tells Mozbot, "Hey, the customer is looking at this product right now!"

### Connecting Mozbot with the OpenAI Assistant

Alright, drumroll please... 🥁 It's time to bring our AI brainiac and our sleek Mozbot interface together!
...
<Image
  ...
  height={872}
/>
1. In your Mozbot flow, add an "OpenAI" block where you want the AI to chime in.
...
Mozbot isn't just smart; it's also quite the chameleon. You've got a whole wardrobe of styling options at your fingertips. Here's how to make your chatbot strut its stuff:

1. Head over to the "Theme" tab in your Mozbot dashboard. This is your bot's personal styling studio.
...
- Don't be afraid to use your logo. Mozbot lets you add a custom avatar for your bot. Why not use your brand mascot or logo?
...
### Step 1: Grab Your Mozbot Code

First things first, we need to get the code for your Mozbot. It's like getting your bot's passport for its journey to Shopify-land.

1. In your Mozbot dashboard, head to the "Share" tab.
...
2. Modify your Mozbot flow to include decision points where the AI can introduce these upselling opportunities.
3. Use Mozbot's conditional logic to tailor the conversation based on the customer's responses and browsing history.
...
Use Mozbot's analytics and Shopify's reporting tools to track these metrics. Don't be afraid to experiment! Try different upselling approaches, tweak your bot's personality, or adjust its appearance. The beauty of AI is that it gets smarter over time, so your upselling game will only get stronger.
...
4. **Customer Satisfaction**: Use Mozbot's built-in feedback options to gauge how helpful customers find the bot.
...
3. **Personalize more**: Use Mozbot's variable system to remember customer preferences and tailor future interactions.
...
2. **Split your traffic**: Use Mozbot's randomization feature to direct 50% of visitors to each version.
