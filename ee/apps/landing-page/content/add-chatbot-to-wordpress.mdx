...
description: 'Learn how to add a chatbot to your WordPress site using Mozbot.'
...
In this article, we'll look at it using Mozbot. Mozbot is a chatbot builder that lets you create advanced conversational apps visually, with no coding needed. It's time to change the way you interact with your audience, boost engagement, and increase conversions for your business.
...
Now, let's talk about **Mozbot**, the chatbot builder that will simplify your life.

**Overview of Mozbot’s Feature-Rich Platform**

Mozbot is like a Swiss Army knife for chatbot builders, packed with useful features:

- **Drag-and-Drop Interface**: No coding needed! Use Mozbot’s visual builder to create chatbots by dragging and dropping elements like text bubbles, input fields, and buttons.
...
Absolutely! Mozbot is designed for non-technical users. If you can navigate WordPress, you can set up your chatbot. Installing it is as easy as adding a plugin and following simple steps.

## Step-by-Step Guide to Add Chatbot in WordPress Using Mozbot

**Install and Activate Mozbot Plugin**

First, let's get the Mozbot plugin onto your WordPress site. You can download it [here](https://wordpress.org/plugins/mozbot/). Or from your Wordpress dashboard:
...
2. **Search for Mozbot**: Type “Mozbot” in the search bar. Click “Install Now” once you find the official Mozbot plugin.

   <Image
     alt="How to look for Mozbot in the WordPress Plugin Directory"
     src="/images/blog/add-chatbot-to-wordpress/mozbot-wordpress-plugin-directory.jpg"
     width={678}
     height={784}
   />

3. **Activate the Plugin**: After installation, click the “Activate” button. Mozbot will now appear in your WordPress menu.

   <Image
     alt="activate Mozbot Plugin"
     src="/images/blog/add-chatbot-to-wordpress/wordpress-mozbot-activate.jpg"
     width={1002}
     height={704}
   />
...
1. **Access Mozbot Settings**: In the WordPress admin area, go to Settings > Mozbot.

   <Image
     alt="Mozbot Settings"
     src="/images/blog/add-chatbot-to-wordpress/wordpress-mozbot-settings.jpg"
     width={1638}
     height={1148}
   />

2. **Log In to Your Mozbot Account**: If you don’t have an account, create one now. After logging in, either create a new Mozbot or open an existing one.
3. **Generate a Code Snippet**: Click on “Share” within Mozbot. Select “WordPress” and click the "Get Code Snippet" button to generate your unique code.

   <Image
     alt="Code snippet for Wordpress"
     src="/images/blog/add-chatbot-to-wordpress/mozbot-share-wordpress.jpg"
     width={1208}
     height={1352}
   />

4. **Paste the Code into WordPress**: Copy the snippet and paste it into the “Code Snippet” field in the Mozbot settings on your WordPress site. Don’t forget to put ‘0.2’ in the Library version.

   <Image
     alt="Mozbot Settings"
     src="/images/blog/add-chatbot-to-wordpress/mozbot-wordpress-filled-settings.jpg"
     width={1560}
     height={1132}
   />

Now you’re set with the basics. But there’s more. Mozbot offers extensive options for customization to make your chatbot exactly how you envision it.

<Image
  src="/images/blog/add-chatbot-to-wordpress/mozbot-chatbot-wordpress.jpg"
...
**Using Mozbot's Drag-and-Drop Interface**

Creating a chatbot should be as simple as dragging and dropping elements into place—like arranging pieces of a puzzle. That's precisely what Mozbot offers. With its intuitive drag-and-drop interface, you can assemble your chatbot visually. **No coding, no headaches.** Just click and configure the building blocks to create a conversational flow that suits your needs.

**Adding Various Conversational Elements**

A one-note chatbot can be as engaging as a brick wall. To keep your visitors interested, you need variety. Mozbot allows you to add:
...
- **Buttons and Quick Replies**: Enhance interactivity with buttons for users to make selections without typing.
  <Image
    src="/images/blog/chatfuel-alternatives/mozbot-integrations.jpg"
    alt="Mozbot integrations"
    width={324}
    height={616}
  />
...
Ever wished your chatbot could respond differently based on user input? With Mozbot, it can. Using conditional logic, you can set up your chatbot to:

- Provide personalized responses.
- Redirect the user based on their choices.
- Trigger specific functions depending on the collected data.

Additionally, Mozbot integrates with leading platforms like OpenAI and Google Sheets. Need to send data to a spreadsheet or fetch information from a webhook? Mozbot covers all these needs.

## Embedding the Chatbot into Your WordPress Site

**Customizing the Chatbot’s Appearance to Match Your Site’s Theme**

The look and feel of your chatbot should blend seamlessly with your website’s aesthetic. Mozbot offers easy theming options:
...
With a cohesive appearance, your chatbot will enhance user experience without feeling like an add-on. Go over the Theme tab to customize your Mozbot. If you need help, you can check out [the documentation](https://docs.mozbot.io/theme/overview).

**Can the Chatbot Be Embedded on Specific Pages Only?**

Absolutely! You can customize where your chatbot appears:

1. **Excluded Pages**: In the Mozbot WordPress settings, use the “Excluded Pages” input to specify where you don’t want the chatbot to appear. For example:
...
- **Personalization**: Use prefilled variables to tailor responses based on user data. For instance, greeting users by their names makes interactions warmer and more human-like. You can also use AI to [customize the chatbot with your data](https://mozbot.io/blog/train-chatbot-on-your-own-data).
...
You can use the Analytics section of the Mozbot app to get all these data.
